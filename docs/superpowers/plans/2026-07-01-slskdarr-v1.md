# slskdarr v1 Implementation Plan
...
- Go module path: `github.com/samuelenocsson/slskdarr`.
...
Run:
```bash
cd /Users/samuelenocsson/dev/slskdarr
go mod init github.com/samuelenocsson/slskdarr
```
...
Run: `docker build -t slskdarr:dev .`
